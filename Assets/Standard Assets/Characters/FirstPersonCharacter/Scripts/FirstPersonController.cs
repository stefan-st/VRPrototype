...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_standingHeight = 2f;
        [SerializeField] private float m_crouchingHeight = 1.25f;
        [SerializeField] private float m_JumpSpeed;
        [SerializeField] private float m_StickToGroundForce;
        [SerializeField] private float m_GravityMultiplier;
        [SerializeField] private float m_CrouchMultiplier;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                SceneManager.LoadScene("Scenes/CozyFirePlace", LoadSceneMode.Single);
